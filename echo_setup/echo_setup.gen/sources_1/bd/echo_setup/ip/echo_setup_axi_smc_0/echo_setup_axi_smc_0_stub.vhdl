...
-- Date        : Wed May  3 20:29:54 2023
-- Host        : jk running 64-bit Ubuntu 20.04.6 LTS
-- Command     : write_vhdl -force -mode synth_stub -rename_top echo_setup_axi_smc_0 -prefix
--               echo_setup_axi_smc_0_ echo_setup_axi_smc_0_stub.vhdl
-- Design      : echo_setup_axi_smc_0
...
entity echo_setup_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
    aclk1 : in STD_LOGIC;
...
end echo_setup_axi_smc_0;

architecture stub of echo_setup_axi_smc_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_fbd2,Vivado 2022.1";
begin
end;
