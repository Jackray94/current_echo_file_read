...
HD_PWD='/home/jack/VERILOG/4_29_onward/echo_attempt7/echo_setup/echo_setup.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log echo_setup_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source echo_setup_wrapper.tcl -notrace
