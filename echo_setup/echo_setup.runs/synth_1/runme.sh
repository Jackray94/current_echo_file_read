...
HD_PWD='/home/jack/VERILOG/4_29_onward/echo_attempt7/echo_setup/echo_setup.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log echo_setup_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source echo_setup_wrapper.tcl
